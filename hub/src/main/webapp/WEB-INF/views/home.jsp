    ...
    <div class="container">
        <div class="scroller py-1 my-2">
            ...
            <nav class="nav justify-content-center">
                <a class="navpanel px-5 py-2 link-secondary border-end border-secondary" href="/about">About</a>
                ...
                <a class="navpanel px-5 py-2 link-secondary border-start border-end border-secondary" href="/simulator">Simulation</a>
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-end">
                        ...
                        <p><a class="btn btn-lg btn-success" href="/about">Find Out More &raquo;</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        ...
                        <p><a class="btn btn-lg btn-success" href="/simulator">Simulate &raquo;</a></p>
                    </div>
                </div>
            </div>
        </div>
