...
<section style="background-color: #eee;">
    <div class="container py-5">
        <div class="row bg-dark mx-auto rounded py- my-5">
            <h2 class="fw-bolder text-center text-light py-2">Your Profile</h2>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <div class="card mb-4">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body mt-4">
                        ...
                        <hr>
                        <a href="/profile-edit"><button type="button" class="btn btn-success mt-3">Edit Details</button></a>
                    </div>
                </div>
                <div class="col-md-12 mb-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            ...
                            <!-- form to create user post -->
                            <form:form action="/submitPostProfile" modelAttribute="postcontent" method="post">
                                <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4 mb-md-0">
                            <div class="card-body">
                                <p class="mb-4"><span class="text-primary font-italic me-1">Your Recent Posts</span> // Community Posts</p>
